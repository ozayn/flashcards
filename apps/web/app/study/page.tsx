    ...
    <PageContainer>
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          Choose a deck or category to start studying.
        </p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <h2 className="text-base font-semibold">Study a Deck</h2>
          </div>
          <p className="text-sm text-muted-foreground leading-relaxed">
            Pick a single deck and study its due flashcards.
          </p>
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <h2 className="text-base font-semibold">Study a Category</h2>
          </div>
          <p className="text-sm text-muted-foreground leading-relaxed">
            Study all decks in a category, one after another.
          </p>
          <span className="inline-flex items-center mt-4 text-sm font-medium text-foreground group-hover:underline">
            Browse categories →
          </span>
